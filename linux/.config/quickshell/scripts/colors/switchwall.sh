#!/usr/bin/env bash
# TODO(coat): Replace matugen calls in this script with your 'coat' tool.
# matugen is called via: matugen "${matugen_args[@]}" (around line 304)
# coat should generate the same material_colors.scss output at:
#   $XDG_STATE_HOME/quickshell/user/generated/material_colors.scss
# Keep everything else in this script the same - just swap the generator.
