...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        "gemini-2.5-flash-lite": aiModelComponent.createObject(this, {
            ...
            "description": Translation.tr("Online | Google's model\nFastest and most budget-friendly model in the 2.5 family. Great for quick tasks."),
        ...
        "gemini-2.5-flash": aiModelComponent.createObject(this, {
            ...
            "icon": "google-gemini-symbolic",
            "description": Translation.tr("Online | Google's model\nBest price-performance model for low-latency, high-volume tasks that require reasoning."),
            "homepage": "https://aistudio.google.com",
        ...
        "gemini-2.5-pro": aiModelComponent.createObject(this, {
            "name": "Gemini 2.5 Pro",
            "icon": "google-gemini-symbolic",
            "description": Translation.tr("Online | Google's model\nMost advanced 2.5 model for complex tasks, featuring deep reasoning and coding capabilities."),
            "homepage": "https://aistudio.google.com",
        ...
        "gemini-3.1-flash-lite": aiModelComponent.createObject(this, {
            ...
            "icon": "google-gemini-symbolic",
            "description": Translation.tr("Online | Google's model\nFrontier-class performance at a fraction of the cost. Latest and lightest Gemini 3 model."),
            "homepage": "https://aistudio.google.com",
        ...
        "gemini-3.1-pro": aiModelComponent.createObject(this, {
            "name": "Gemini 3.1 Pro",
            "icon": "google-gemini-symbolic",
            "description": Translation.tr("Online | Google's model\nAdvanced intelligence, complex problem-solving, and powerful agentic capabilities. Latest Gemini 3 Pro."),
            "homepage": "https://aistudio.google.com",
