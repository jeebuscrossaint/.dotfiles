                            ...
                            onActiveChanged: {
                                if (active) {
                                    ...
                                    if (root.hoveredWorkspace !== null && root.hoveredWorkspace.workspace !== windowItem.hyprlandClient.workspace.id) {
                                                if (Compositor.isHyprland) Hyprland.dispatch(`movetoworkspacesilent ${root.hoveredWorkspace.workspace}, address:${windowItem.hyprlandClient.address}`);
                                    } else {
            ...
            WListView {
                ...
                delegate: TaskViewWorkspace {
                    ...
                    onClicked: {
                        ...
                        Compositor.switchWorkspace(workspaceItem.workspace);
                    }
                }
            }
        }
