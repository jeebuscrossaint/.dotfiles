...
PanelWindow {
    ...
    readonly property var windows: Compositor.isHyprland ? [...HyprlandData.windowList].sort((a, b) => {
    ...
    ScreencopyView {
        ...
        DragManager {
            ...
            property var hoveredWindow: root.windows.find(w => {
                const inCurrentWorkspace = !Compositor.isHyprland || w.workspace.id === HyprlandData.activeWorkspace?.id;
